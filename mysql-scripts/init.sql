-- Create the database
CREATE DATABASE IF NOT EXISTS ecommerce_productsdatabase;
USE ecommerce_productsdatabase;
...
CREATE TABLE IF NOT EXISTS products (
  ...
  RowVersion datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (Id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Insert 12 sample rows into the products table with specified categories
INSERT INTO products (Id, Name, Category, UnitPrice, QuantityInStock) VALUES
